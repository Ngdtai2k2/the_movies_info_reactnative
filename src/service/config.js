...
export const IMAGE_URL= 'https://i.imgur.com/RYQqUwG.png';
export const IMAGE_PEOPLE = 'https://i.imgur.com/tG4kSty.png';
export const VIDEO_YOUTUBE = 'https://www.youtube.com/watch?v=';